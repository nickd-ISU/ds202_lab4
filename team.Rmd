...
*For this problem, I think the best way to look at how brock purdy's preformance is related to the entire team preformance, is by looking at his passing yards. Brock Purdy usually has one job every play and that is to pass the ball or run it if he can. The further he passes/runs the ball successfully. the better hos preformance. We'll look at these numbers in relation with other players*
```{r}
